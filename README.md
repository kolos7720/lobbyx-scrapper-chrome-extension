...
Парсинг сторінки відбувається допоки не будуть оброблені всі заявки в вакансії або допоки на сторінці не зустрінеться тег "scrapped", в такому випадку вважається, що попередні канидати оброблені і можна перейти до наступної сторінки/вакансії.
